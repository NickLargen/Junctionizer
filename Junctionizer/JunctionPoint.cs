...
/**Original source: http://www.codeproject.com/Articles/15633/Manipulating-NTFS-Junction-Points-in-NET
    ...
    public static class JunctionPoint
    {
        ...
        private static void Create(string junctionPoint, string targetDir, bool overwrite)
        {
            ...
            using (SafeFileHandle handle = OpenReparsePoint(junctionPoint, EFileAccess.GenericWrite))
            {
                ...
                try
                {
                    ...
                    bool result = DeviceIoControl(handle.DangerousGetHandle(), FSCTL_SET_REPARSE_POINT,
                        inBuffer, targetDirBytes.Length + 20, IntPtr.Zero, nOutBufferSize: 0, pBytesReturned: out int _,
        ...
        private static string GetTarget(string junctionPoint)
        {
        ...
        private static string InternalGetTarget(SafeFileHandle handle)
        {
            ...
            try
            {
                ...
                if (targetDir.StartsWith(NON_INTERPRETED_PATH_PREFIX, StringComparison.Ordinal)) targetDir = targetDir.Substring(NON_INTERPRETED_PATH_PREFIX.Length);
